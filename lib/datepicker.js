...
Datepicker = (function(_super) {
  ...
  Datepicker.prototype._show = function() {
    ...
    this._viewType = this.opts.monthOnly ? 'yearmonth' : this.opts.viewType;
  ...
  Datepicker.prototype.update = function(date, type) {
    ...
    this._yearmonth = this.cal.find('.datepicker-yearmonth').data('tmpDate', date.clone().startOf('month'));
    this._viewType = type;
    this._viewDate = date;
    if (this.opts.monthOnly && type === 'yearmonth') {
      return this.cal.find('.datepicker-yearmonth-confirm').remove();
    }
  };
  ...
  Datepicker.prototype._bindEvent = function() {
    return this.cal.on('mousedown click', function(e) {
    ...
    })(this)).on('click', '.datepicker-yearmonth-cancel, .datepicker-yearmonth-title', (function(_this) {
      return function(e) {
        if (_this.opts.monthOnly) {
          return;
        }
    ...
    })(this)).on('click', '.datepicker-year-prev, .datepicker-year-next', (function(_this) {
      return function(e) {
        var btn, currentYear, direction, firstYear, years;
        e.preventDefault();
        btn = $(e.currentTarget);
        currentYear = _this._yearmonth.data('tmpDate').year();
        direction = btn.is('.datepicker-year-prev') ? -10 : 10;
      ...
      return function(e) {
        ...
        btn.addClass('selected');
        _this.cal.find('.datepicker-yearmonth-title').html(_this._formatTitle(date));
        if (!isYear) {
          if (_this.opts.monthOnly) {
            _this.setSelectedDate(date);
            if (!_this.opts.inline) {
