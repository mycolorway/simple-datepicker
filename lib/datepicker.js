...
Datepicker = (function(superClass) {
    ...
    this.cal.on('keydown', '.datepicker-header input', (function(_this) {
      return function(e) {
        ...
        if (key === 9) {
          ...
          return;
        } else if ([8, 37, 37, 39].indexOf(key) !== -1) {
          return;
        }
  ...
  Datepicker.prototype._update = function() {
    ...
    if (!this.opts.monthpicker && oldMonth !== month) {
  ...
  Datepicker.prototype._refresh = function() {
    ...
    if (!this.opts.monthpicker && oldMonth !== this.date.month() + 1) {
      this._calendar.replaceWith(this._renderCal());
      this._calendar = this.cal.find('.panel-day');
    }
    this.cal.find('.selected').removeClass('selected');
  ...
  Datepicker.prototype._renderYearSelector = function(from) {
    ...
    el += '<p class="datepicker-year" data-year="prev"><i class="icon-chevron-left"><span>&lt;</span></i></p><p class="datepicker-year" data-year="next"><i class="icon-chevron-right"><span>&gt;</span></i></p>';
    return el += '</div>';
  };
