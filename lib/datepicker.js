...
Datepicker = (function(_super) {
  ...
  Datepicker.prototype._renderYearMonth = function(viewDate) {
    var currentMonth, currentYear, next, noSelected, prev, title;
    prev = '';
    next = '';
