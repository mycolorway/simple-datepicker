(function() {
  ...
  Datepicker = (function(_super) {
    ...
    Datepicker.prototype.update = function() {
      var c, date, days, firstDate, html, i, lastDate, monthNames, n, offset, p, prevLastDate, row, showN, showP, theDate, titleMonthYear, today, until_, x, y;
      today = mcw.now().startOf("day");
