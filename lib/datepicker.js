...
Datepicker = (function(_super) {
  ...
  Datepicker.prototype.update = function(date) {
    var calendar, calendarHidden, offset, theDate, today, yearmonth, yearmonthHidden;
    ...
    if (this.cal) {
      calendarHidden = this.cal.find('.calendar').is(':hidden');
      yearmonthHidden = this.cal.find('.datepicker-yearmonth').is(':hidden');
    }
    calendar = this._renderCal(theDate, calendarHidden);
    yearmonth = this._renderYearMonthSelector(theDate, yearmonthHidden);
    if (!this.cal) {
      ...
      this.cal.on("mousedown", function(e) {
        ...
        return function(e) {
          _this.cal.find('.datepicker-yearmonth').show();
          return _this.cal.find('.calendar').hide();
        };
        ...
        return function(e) {
          _this.cal.find('.datepicker-yearmonth').hide();
          return _this.cal.find('.calendar').show();
        };
    ...
    this.cal.html(calendar + yearmonth);
    return this.trigger("beforeUpdate", [this.cal]);
  };

  Datepicker.prototype._renderCal = function(theDate, hidden) {
  ...
  Datepicker.prototype._renderYearMonthSelector = function(theDate, hidden) {
    ...
    return "<div class='datepicker-yearmonth' " + (hidden ? ' style=\'display:none;\'' : '') + " data-year='" + currentYear + "' data-month='" + currentMonth + "'>" + title + year + month + confirm + "</div>";
  };
